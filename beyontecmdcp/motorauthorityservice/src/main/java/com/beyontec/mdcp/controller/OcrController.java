...
import com.beyontec.mdcp.model.OcrModel;
	...
	public String DoOCR(@RequestParam("DestinationLanguage") String destinationLanguage,
		...
		try {
			...
			g.dispose();
			 ...
			 File file = new File(classLoader.getResource(".").getFile() + "/tessdata");
			instance.setLanguage(request.getDestinationLanguage());
			instance.setDatapath(file.getPath());
